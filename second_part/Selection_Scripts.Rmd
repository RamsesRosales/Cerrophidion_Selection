---
title: "R_SCRIPTS:Sequence divergence in venom genes within and between *Cerrophidion*
  (Viperidae\ :\ Crotalinae) species is driven by mutation-drift equilibrium."
...
**Jounal of Molecular Ecology**<br>
...
```
source functions to make a table summarysing all the statistic test results, the table and all other files required to run the scripts are available at https://github.com/RamsesRosales/Cerrophidion_BMC
